const debug = require('debug')('linto:skill:v2:linto-skill:linto-skill-greeting-demo')
...
const PALETTE_NODE_NAME = 'Greeting'
const SKILL_NAME = 'linto-skill-greeting-demo'

module.exports = function (RED) {
  function Node(config) {
    RED.nodes.createNode(this, config)
    new LintoSkillGreetingDemo(RED, this, config)
  }

  RED.nodes.registerType(SKILL_NAME, Node,
    {
      settings: {
        lintoSkillGreetingDemo: {
          value: {
...
class LintoSkillGreetingDemo extends LintoSkillNode {
